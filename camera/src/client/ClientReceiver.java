...
public class ClientReceiver extends Thread {
	...
	/*
	 * Blocked by inputstream until package is getting sent.
	 * Takes the package, identifies it and does the appropriate monitor operation.
	 * Dies by SocketException (when socket closes)
