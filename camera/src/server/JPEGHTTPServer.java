...
public class JPEGHTTPServer extends Thread{
	...
	public JPEGHTTPServer(int port,ServerMonitor monitor) {
...
//						}
						...
						//int startIndex=ServerMonitor.ID_SIZE+ServerMonitor.LEN_SIZE+ServerMonitor.TS_SIZE;
						
						byte[] pictureData=monitor.getLastJPEG();
						
						//int jpegLength=pictureData.length-startIndex;
						//byte[] jpeg=new byte[jpegLength];
						//for(int i=startIndex;i<pictureData.length;i++){
						//	jpeg[i-startIndex]=pictureData[i];
						//}
